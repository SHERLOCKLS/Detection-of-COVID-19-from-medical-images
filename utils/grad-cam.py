...
def test(image_paths, output_dir, cuda):
    ...
    model = make_model('mynet', num_classes=config.num_classes, pretrained=False)
    ...
    # The four residual layers
    target_layers = ["_features.0","_features.1","_features.2","_features.3", "_features.4", "_features.5", "_features.6", "_features.7"]
